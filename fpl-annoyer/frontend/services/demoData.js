...
export const DEMO_ACCOUNTS = {
    "900001": {
      ...
      shame: {
        ...
        average_score: 52,
        surplus: 6,
        message: "🎯 CONGRATS! You're FINALLY doing something right. You scored 58 points in GW20, which is 6 above average. Could be better though.",
        shamed: false,
      },
    },
    ...
    "900002": {
      ...
      shame: {
        ...
        average_score: 52,
        deficit: 21,
        message: "🔥 WHAT DO YOU THINK OF TOTTENHAM? YOUUUU!!! You scored 31 points in GW22, but the average was 52. You're 21 points below average! Get it together!",
        shamed: true,
      },
    },
